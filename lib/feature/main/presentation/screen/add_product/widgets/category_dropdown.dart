...
import '../../../../domain/model/category_model.dart'; // Import the new model
...
class CategoryDropdown extends StatelessWidget {
  ...
  final String hint;
  final CategoryModel? value; // Change to CategoryModel
  final List<CategoryModel> dropdownItems; // Change to list of CategoryModel
  final ValueChanged<CategoryModel?>?
      onChanged; // Change to handle CategoryModel
          ...
          items: dropdownItems
              .map((CategoryModel item) => DropdownMenuItem<CategoryModel>(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        item.name, // Display the CategoryModel name
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
